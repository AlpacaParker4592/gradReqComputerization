...
이후 HUS 또는 PPE 과목으로 전환됐을 경우 전환된 코드로 변경되도록 하였습니다.
    + ex) "강대국의 흥망" 과목을 2017년 이전에 이수했어도 2018년 이후에 HUS 코드로 변경됐으므로 **HUS 과목을 이수한 것으로 처리**
...
+ 실행 중 오류가 발생하거나 나온 결과가 실제 반영되는 학점과 다른 사항을 발견할 시 **lhh-znso4(at)gm.gist.ac.kr**로 연락 바랍니다.